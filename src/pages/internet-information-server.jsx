...
export default function InternetInformationServer() {
  useEffect(() => {
    // Dynamic SEO Injection
    document.title = "Internet Information Server - STO Digital";
    
    let metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) {
      metaDesc.setAttribute('content', "IIS is again a webserver developed by Microsoft with windows NT family. It is distributed along with windows NT. It is used for hosting websites and other content on the web.");
    } else {
  ...
  <div className="container">
     <div className="row img-row">
            ...
            <div className="col-md-5 text-center">
                <h1 className="font-weight-bold">INTERNET INFORMATION SERVER</h1>
            </div>
            <div className="col-md-7 text-center img-div">
                <img src="/debug/img/iis.png" alt="html5 and css3" width="60%" height="60%" className="img-fluid" />
            </div>
...
<section className="technologies-cta">
       ...
       <div className="row">
        ...
        <div className="row p-4 shadow-common contents-tech" style={{"backgroundColor":"white"}}>
            ...
            <div className="col-sm-12">
                <h2 className="font-weight-bold text-center pb-2">Internet Information Server </h2>
                <div className="row">
                    <p className="text-justify para-color px-5">IIS is again a webserver developed by Microsoft with windows NT family.  It is distributed along with windows NT. It is used for hosting websites and other content on the web. IIS has rich graphical interface to manage the webserver which keeps it in the front runner for the ease of use. IIS has inbuilt support for the Microsoft technologies like Microsoft  sharepoint Microsoft visual studio .NET, web distributed Authoring and Versioning (WebDAV). WebDAV makes the content creation fast and easy. </p>                </div>
            </div>
        ...
        <div className="row p-4 shadow-common contents-tech" style={{"backgroundColor":"white"}}>
            ...
            <div className="col-sm-12">
                <h2 className="font-weight-bold text-center pb-2">Why Internet information Server?</h2>
                <h5 className="font-weight-bold">IIS includes:</h5>
                <div className="row">
	...
	<form id="contactSeo" className="web_analysis">
		<div className="row px-3 py-2">
			...
			<input type="hidden" name="lead_url" defaultValue="/internet-information-server" />
