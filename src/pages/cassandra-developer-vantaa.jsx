...
export default function CassandraDeveloperVantaa() {
  useEffect(() => {
    // Dynamic SEO Injection
    document.title = "Cassandra - STO Digital";
    
    let metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) {
      metaDesc.setAttribute('content', "Apache Casandra is another opensource database management system, it is NoSQL database, which rely on the key value to manipulate and store the data.");
    } else {
  ...
  <div className="container">
       <div className="row img-row">
            ...
            <div className="col-md-5 text-center">
                <h1 className="font-weight-bold">Cassandra</h1>
            </div>
            <div className="col-md-7 text-center img-div">
                <img src="/debug/img/casandra.png" alt="html5 and css3" width="40%" height="40%" className="img-fluid" />
            </div>
...
<section className="technologies-cta">
    <div className="container-fluid">
      <div className="row">
                ...
                <div className="row">
                    ...
                    <div className="col-md-6 para-color">
                        <ul className="para-color mb-0" style={{"listStyleType":"none","paddingLeft":"10px"}}>
                            <li>
                                <img src="/debug/img/tick.svg" className="img-fluid list-icon" alt="tick" width="20" height="20" />
                                MySQL along with a myriad of other databases store data and indexes so that you can access the data quickly, zeroing in on the piece of information you are looking for by accessing the index that gets you to it the fastest.</li>
        ...
        <div className="row p-4 shadow-common contents-tech" style={{"backgroundColor":"white"}}>
            ...
            <div className="col-sm-12">
                <h2 className="font-weight-bold text-center pb-2">Why Cassandra?</h2>
                <div className="row">
	...
	<form id="contactSeo" className="web_analysis">
		<div className="row px-3 py-2">
			...
			<input type="hidden" name="lead_url" defaultValue="/cassandra-developer-vantaa" />
