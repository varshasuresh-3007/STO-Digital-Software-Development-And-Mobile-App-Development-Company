    ...
    <div className="container">
        <div className="row" style={{"height":"35vh"}}>
            <div className="col-sm-5 text-center">
                <h1 className="font-weight-bold vertical-alignment">Matrimony</h1>
            </div>
            <div className="col-sm-7 main-image text-center">
                <img src="/uploads/1627303136906.png" alt="product page image" width="60%" height="60%" className="product-drlog" />
        ...
        <div className="row mt-4">
            ...
            <div className="col-sm-4 product-demo text-center">
                <a href="https://matrimony1.sto-digital.com/" target="_blank" className="social-btns">
...
<section className="technology--info technology__margin-0">
        ...
        <div className="product-description--div p-4">
            <div className="row technology_contents-ui">
                <div className="col-sm-12">
                    <h2 className="font-weight-bold text-let pb-2 text-center">About Matrimony</h2>
                </div>
            </div>
            <div className="row project-mean">
                <div className="col-sm-12">
                    <p className="text-justify px-5 pb-1 mb-0">
						Matrimony Application  provides both matchmaking and marriage related services through website and Android App					</p>
                </div>
            </div>
        </div>
            ...
            <div className="row project-mean">
                <div className="col-sm-12">
                    <p className="text-justify px-5 pb-3">
						</p><p>Matrimony profile description is&nbsp;a descriptive text that provides a summary about the person in terms of educational background, profession, personality, lifestyle, and hobbies. In addition, it may include a brief summary of the family background along with a summary of partner expectations for marriage.</p>
					<p></p>
                </div>
            </div>
	...
	<form id="contactSeo" className="web_analysis">
		<div className="row px-3 py-2">
			...
			<input type="hidden" name="lead_url" defaultValue="/matrimony" />
