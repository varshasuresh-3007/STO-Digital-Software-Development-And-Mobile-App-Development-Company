...
export default function DoctorClickAway() {
  useEffect(() => {
    // Dynamic SEO Injection
    document.title = "Doctor Click Away";
    ...
    <div className="container">
        <div className="row" style={{"height":"35vh"}}>
            <div className="col-sm-5 text-center">
                <h1 className="font-weight-bold vertical-alignment">Doctor Click Away</h1>
            </div>
            <div className="col-sm-7 main-image text-center">
                <img src="/uploads/doctor_click.png" alt="product page image" width="60%" height="60%" className="product-drlog" />
        ...
        <div className="row mt-4">
            ...
            <div className="col-sm-4 product-demo text-center">
                <a href="https://www.doctorclickaway.com" target="_blank" className="social-btns">
        ...
        <div className="product-description--div p-4">
            <div className="row technology_contents-ui">
                <div className="col-sm-12">
                    <h2 className="font-weight-bold text-let pb-2 text-center">About Doctor Click Away</h2>
                </div>
            </div>
            <div className="row project-mean">
                <div className="col-sm-12">
                    <p className="text-justify px-5 pb-1 mb-0">
						Doctor Click Away has a group of highly skilled and famous doctors with the aim to provide next generation medical solutions.

One of the main ways Doctor Click Away seeks to reduce health care costs is by engaging doctors, hospitals and other health care providers to form networks that coordinate patient care. Doctor click away provides video call facility to connect with doctors and it has a vital feature called Virtual Blood Bank through which you can ask other users to donate blood.					</p>
                </div>
            </div>
        </div>
            ...
            <div className="row">
				<div className="col-md-6 ">
                    ...
                    <div className="product_list">
                        <ul className="square mb-0">
                            <li>Online storage and retrieval of health history
</li>
                        </ul>
                    </div>
                </div><div className="col-md-6 ">
                    ...
                    <div className="product_list">
                        <ul className="square mb-0">
                            <li>Location based Doctor Search
</li>
                        </ul>
                    </div>
                </div><div className="col-md-6 ">
            ...
            <div className="row project-mean">
                <div className="col-sm-12">
                    <p className="text-justify px-5 pb-3">
						</p><p>The purpose of Doctor Click Away is to reduce the communication gap between patients and doctors in a way that they can communicate to each other from anywhere, anytime</p>
...
<p>We aim to cover more cities and towns across the globe in the next few years and have more doctors from across specialties on the Doctor Click Away platform for online consultation</p>
	...
	<form id="contactSeo" className="web_analysis">
		<div className="row px-3 py-2">
			...
			<input type="hidden" name="lead_url" defaultValue="/doctor-click-away" />
