    ...
    <div className="container">
        <div className="row" style={{"height":"35vh"}}>
            <div className="col-sm-5 text-center">
                <h1 className="font-weight-bold vertical-alignment">E-Learning</h1>
            </div>
            <div className="col-sm-7 main-image text-center">
                <img src="/uploads/e-learning.png" alt="product page image" width="60%" height="60%" className="product-drlog" />
        ...
        <div className="row mt-4">
            ...
            <div className="col-sm-4 product-demo text-center">
                <a href="https://www.techaedu.com/" target="_blank" className="social-btns">
        ...
        <div className="product-description--div p-4">
            <div className="row technology_contents-ui">
                <div className="col-sm-12">
                    <h2 className="font-weight-bold text-let pb-2 text-center">About E-Learning</h2>
                </div>
            </div>
...
Pre-recorded content such as lectures, documentaries and other video content are delivered in a store and forward model so that the material can be viewed when needed. Computer-based training or self-paced learning is providing through this platform.					</p>
                </div>
            </div>
        </div>
...
<p>We provide custom e- Learning, LMS (learning management system) and CMS development and mobile learning solutions.</p>
</div>

<div className="row">
<p>Pre-recorded content such as lectures, documentaries and other video content are delivered in a store and forward model so that the material can be viewed when needed.</p>
</div>
					<p></p>
                </div>
            </div>
	...
	<form id="contactSeo" className="web_analysis">
		<div className="row px-3 py-2">
			...
			<input type="hidden" name="lead_url" defaultValue="/e-learning" />
