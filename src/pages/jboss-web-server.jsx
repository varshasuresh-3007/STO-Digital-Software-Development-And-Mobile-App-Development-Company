...
export default function JbossWebServer() {
  useEffect(() => {
    // Dynamic SEO Injection
    document.title = "JBOSS Web Server - STO Digital";
    
    let metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) {
      metaDesc.setAttribute('content', "JBOSS an acronym for JavaBeans Open Source Software. JBOSS is an enterprise Application platform. Licensing is Subscription based or opensource. Java EE based application server runtime platform used for building deploying and hosting highly transactional java applications and services.");
    } else {
    ...
    <div className="container">
       <div className="row img-row">
            ...
            <div className="col-md-5 text-center">
                <h1 className="font-weight-bold">JBOSS Web Server</h1>
            </div>
            <div className="col-md-7 text-center img-div">
                <img src="/debug/img/jboss.png" alt="html5 and css3" width="60%" height="60%" className="img-fluid" />
            </div>
   ...
   <div className="container-fluid">
     <div className="row">
        ...
        <div className="row p-4 shadow-common contents-tech" style={{"backgroundColor":"white"}}>
            ...
            <div className="col-sm-12">
                <h2 className="font-weight-bold text-center pb-2">Red Hat JBoss Web Server</h2>
                <div className="row">
                    <p className="text-justify para-color px-5">JBOSS an acronym for JavaBeans Open Source Software.  JBOSS is an enterprise Application platform. Licensing is Subscription based or opensource. Java EE based application server runtime platform used for building deploying and hosting highly transactional java applications and services.  JBoss Web Server is an enterprise ready web server designed for medium and large applications, based on Tomcat. JBoss Web Server provides organizations with a single deployment platform for Java Server Pages (JSP) and Java Servlet technologies, PHP, and CGI.                    </p>
                </div>
            </div>
        ...
        <div className="row p-4 shadow-common contents-tech" style={{"backgroundColor":"white"}}>
            ...
            <div className="col-sm-12">
                <h2 className="font-weight-bold text-center pb-2">Why JBoss Web Server?</h2>
                <h5 className="font-weight-bold">JBoss Web Server includes:</h5>
                <div className="row">
                    <p className="text-justify para-color px-5">
                        JBoss Web Framework Kit provides support for multiple programming styles and open source frameworks in a single solution. It includes enterprise-ready versions of Google Web Toolkit (GWT), RichFaces, Spring Framework, and Apache Struts.
                    </p>
                </div>
            </div>
	...
	<form id="contactSeo" className="web_analysis">
		<div className="row px-3 py-2">
			...
			<input type="hidden" name="lead_url" defaultValue="/jboss-web-server" />
