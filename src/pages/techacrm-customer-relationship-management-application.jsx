...
export default function TechacrmCustomerRelationshipManagementApplication() {
  useEffect(() => {
    // Dynamic SEO Injection
    document.title = "TechaCRM(Customer Relationship Management)Application";
    ...
    <div className="container">
        <div className="row" style={{"height":"35vh"}}>
            <div className="col-sm-5 text-center">
                <h1 className="font-weight-bold vertical-alignment">TechaCRM(Customer Relationship Management)Application</h1>
            </div>
            <div className="col-sm-7 main-image text-center">
                <img src="/uploads/leader_crm_blue_(3)1.svg" alt="product page image" width="60%" height="60%" className="product-drlog" />
        ...
        <div className="row mt-4">
            ...
            <div className="col-sm-4 product-demo text-center">
                <a href="https://crm.sto-digital.com/" target="_blank" className="social-btns">
			...
			<div className="col-sm-4 gplay text-right">
				<a href="https://play.google.com/store/apps/details?id=com.sto-digital.lead" target="_blank" className="social-btns my-md-auto my-3">
			...
			<div className="col-sm-4 social-btns text-center astore">
				<a href="https://apps.apple.com/us/app/leader-crm/id1577402840" target="_blank">
        ...
        <div className="product-description--div p-4">
            <div className="row technology_contents-ui">
                <div className="col-sm-12">
                    <h2 className="font-weight-bold text-let pb-2 text-center">About TechaCRM(Customer Relationship Management)Application</h2>
                </div>
            </div>
            <div className="row project-mean">
                <div className="col-sm-12">
                    <p className="text-justify px-5 pb-1 mb-0">
						Leader CRM  is a deliberate interaction wherein approaching leads are qualified, investigated, and sustained with the goal that they can be changed over into new business openings.					</p>
                </div>
            </div>
        </div>
				...
				<div className="col-md-6 ">
                    <div className="product_list">
                        <ul className="square mb-0">
                            <li>Graphical representation of lead</li>
                        </ul>
                    </div>
                </div><div className="col-md-6 ">
                    <div className="product_list">
                        <ul className="square mb-0">
                            <li>Option to change company</li>
                        </ul>
                    </div>
                </div><div className="col-md-6 ">
                    <div className="product_list">
                        <ul className="square mb-0">
                            <li>Create the Leads</li>
                        </ul>
                    </div>
                </div><div className="col-md-6 ">
                    <div className="product_list">
                        <ul className="square mb-0">
                            <li> customer query  Option</li>
                        </ul>
                    </div>
                </div><div className="col-md-6 ">
                    <div className="product_list">
                        <ul className="square mb-0">
                            <li>User can create new company to add group Leads under different company</li>
                        </ul>
                    </div>
                </div>            </div>
...
<div>
<p>STO Digital Leader CRM&nbsp;is the best web application for field leader CRM , add leads, schedule meetings, add notes, run reports and track leads until they convert. Leader CRM&nbsp;web portal&nbsp;and&nbsp;leader CRM&nbsp;application&nbsp;assists organizations with understanding which methodologies get the best leads and upgrade their business Or showcasing efforts in likewise manner. It additionally assists organizations with understanding the client venture, trouble spots of the clients, and bottlenecks in their current cycles. Leader CRM&nbsp;is urgent for effective deals activities. We're adaptable and our creator features integrations with a large group of significant&nbsp;lead management web application&nbsp;like Quickbooks, Zapier, and G Suite to guarantee consistent network between your different useful&nbsp;applications. You can likewise coordinate with undeniable Lead arrangements like Salesforce to execute progressed lead capability and lead sustaining work processes.</p>
...
<div className="col-md-6 d-flex align-items-center justify-content-center">&nbsp;</div>
	...
	<form id="contactSeo" className="web_analysis">
		<div className="row px-3 py-2">
			...
			<input type="hidden" name="lead_url" defaultValue="/techacrm-customer-relationship-management-application" />
