    ...
    <div className="container">
        <div className="row" style={{"height":"35vh"}}>
            <div className="col-sm-5 text-center">
                <h1 className="font-weight-bold vertical-alignment">E Kart</h1>
            </div>
            <div className="col-sm-7 main-image text-center">
                <img src="/uploads/ekart_logo.png" alt="product page image" width="60%" height="60%" className="product-drlog" />
        ...
        <div className="row mt-4">
            ...
            <div className="col-sm-4 product-demo text-center">
                <a href="https://www.wmsjanitorialsupplies.co.uk/" target="_blank" className="social-btns">
...
<section className="technology--info technology__margin-0">
        ...
        <div className="product-description--div p-4">
            <div className="row technology_contents-ui">
                <div className="col-sm-12">
                    <h2 className="font-weight-bold text-let pb-2 text-center">About E Kart</h2>
                </div>
            </div>
            <div className="row project-mean">
                <div className="col-sm-12">
                    <p className="text-justify px-5 pb-1 mb-0">
						Ekart provides you with a convenient way to sale from your grocery shopping app. 					</p>
                </div>
            </div>
        </div>
            ...
            <div className="row project-mean">
                <div className="col-sm-12">
                    <p className="text-justify px-5 pb-3">
						</p><p>eKart Grocery app can sale grocery product, preferred brands, kitchen needs, essential home supplies and more, through this online, one-stop grocery store. It provides you with a convenient way to sale from your grocery shopping app. You can use this app as one big super market app to sale product of your store. This app make easy for user to buy product from store with easy steps and store can get easy order.</p>
					<p></p>
                </div>
            </div>
	...
	<form id="contactSeo" className="web_analysis">
		<div className="row px-3 py-2">
			...
			<input type="hidden" name="lead_url" defaultValue="/e-kart" />
