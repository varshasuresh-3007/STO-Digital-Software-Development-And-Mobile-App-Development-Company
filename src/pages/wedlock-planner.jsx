...
export default function WedlockPlanner() {
  useEffect(() => {
    // Dynamic SEO Injection
    document.title = "Wedlock Planner";
    ...
    <div className="container">
        <div className="row" style={{"height":"35vh"}}>
            <div className="col-sm-5 text-center">
                <h1 className="font-weight-bold vertical-alignment">Wedlock Planner</h1>
            </div>
            <div className="col-sm-7 main-image text-center">
                <img src="/uploads/logo2.png" alt="product page image" width="60%" height="60%" className="product-drlog" />
        ...
        <div className="row mt-4">
            ...
            <div className="col-sm-4 product-demo text-center">
                <a href="https://www.wedlockplanner.com/" target="_blank" className="social-btns">
...
<section className="technology--info technology__margin-0">
        ...
        <div className="product-description--div p-4">
            <div className="row technology_contents-ui">
                <div className="col-sm-12">
                    <h2 className="font-weight-bold text-let pb-2 text-center">About Wedlock Planner</h2>
                </div>
            </div>
            <div className="row project-mean">
                <div className="col-sm-12">
                    <p className="text-justify px-5 pb-1 mb-0">
						We’re Wed Lock Planner, an event management as well as wedding planner in Vantaa and we do magic to make your dream come true. Apart from wedding planning services, we also undertake birthday events, party events, and association events. Our creative team will plan, arrange and execute each concept and theme strategically to match up to your dream of what celebrations are like. We will also communicate with dozens of suppliers and guests to coordinate.					</p>
                </div>
            </div>
        </div>
	...
	<form id="contactSeo" className="web_analysis">
		<div className="row px-3 py-2">
			...
			<input type="hidden" name="lead_url" defaultValue="/wedlock-planner" />
