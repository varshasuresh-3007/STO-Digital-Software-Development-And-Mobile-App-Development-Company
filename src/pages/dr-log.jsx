...
export default function DrLog() {
  useEffect(() => {
    // Dynamic SEO Injection
    document.title = "Dr. Log";
    ...
    <div className="container">
        <div className="row" style={{"height":"35vh"}}>
            <div className="col-sm-5 text-center">
                <h1 className="font-weight-bold vertical-alignment">Dr. Log</h1>
            </div>
            <div className="col-sm-7 main-image text-center">
                <img src="/uploads/drlog_new.png" alt="product page image" width="60%" height="60%" className="product-drlog" />
        ...
        <div className="row mt-4">
            ...
            <div className="col-sm-4 product-demo text-center">
                <a href="https://www.drlog.in/" target="_blank" className="social-btns">
        ...
        <div className="product-description--div p-4">
            <div className="row technology_contents-ui">
                <div className="col-sm-12">
                    <h2 className="font-weight-bold text-let pb-2 text-center">About Dr. Log</h2>
                </div>
            </div>
            ...
            <div className="row">
				<div className="col-md-6 ">
                    ...
                    <div className="product_list">
                        <ul className="square mb-0">
                            <li>Offline Access On Mobile Apps
</li>
                        </ul>
                    </div>
                </div>            </div>
...
<p>A guide for doctors to maintain their logbooks and patient records.</p>
</div>

<div className="row">
<p>Dr. Log is an application which helps to capture the information by the end user.</p>
</div>

<div className="row">
<p>All data is saved on secured server in USER Specific domain (No other user can access the data)</p>
</div>

<div className="row">
<p>It will help in data reviewing, analysis, generating reports, making case summaries etc.</p>
</div>
					<p></p>
                </div>
            </div>
	...
	<form id="contactSeo" className="web_analysis">
		<div className="row px-3 py-2">
			...
			<input type="hidden" name="lead_url" defaultValue="/dr-log" />
