...
export default function RedisDeveloperVantaa() {
  useEffect(() => {
    // Dynamic SEO Injection
    document.title = "Redis - STO Digital";
    
    let metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) {
      metaDesc.setAttribute('content', "Redis is an opensource data structure store, it is distributed under BSD license. Redis stands for Remote DIctionary Server. Redis is extremely fast Inmemory data store. It does not support SQL and that makes it much faster.");
    } else {
 ...
 <div className="container">
     <div className="row img-row">
            ...
            <div className="col-md-5 text-center">
                <h1 className="font-weight-bold">REDIS</h1>
            </div>
            <div className="col-md-7 text-center img-div">
                <img src="/debug/img/redis.png" alt="html5 and css3" width="40%" height="40%" className="img-fluid" />
            </div>
...
<section className="technologies-cta">
	...
	<form id="contactSeo" className="web_analysis">
		<div className="row px-3 py-2">
			...
			<input type="hidden" name="lead_url" defaultValue="/redis-developer-vantaa" />
