    ...
    <div className="container">
        <div className="row" style={{"height":"35vh"}}>
            <div className="col-sm-5 text-center">
                <h1 className="font-weight-bold vertical-alignment">Grocery</h1>
            </div>
            <div className="col-sm-7 main-image text-center">
                <img src="/uploads/1627303136894.png" alt="product page image" width="60%" height="60%" className="product-drlog" />
        ...
        <div className="row mt-4">
            ...
            <div className="col-sm-4 product-demo text-center">
                <a href="https://grocery.sto-digital.com" target="_blank" className="social-btns">
			...
			<div className="col-sm-4 social-btns text-center astore">
				<a href="https://apps.apple.com/us/app/grocery-delivery-partner/id1583578579" target="_blank">
...
<section className="technology--info technology__margin-0">
        ...
        <div className="product-description--div p-4">
            <div className="row technology_contents-ui">
                <div className="col-sm-12">
                    <h2 className="font-weight-bold text-let pb-2 text-center">About Grocery</h2>
                </div>
            </div>
            <div className="row project-mean">
                <div className="col-sm-12">
                    <p className="text-justify px-5 pb-1 mb-0">
						Grocery is the customer end of the grocery delivery app. In short, this is the one that  customers are going to use. It helps them access the grocery shopping app, choose a local grocery vendor, place their order and make the payment.					</p>
                </div>
            </div>
        </div>
            ...
            <div className="row project-mean">
                <div className="col-sm-12">
                    <p className="text-justify px-5 pb-3">
						</p><p>The Grocery&nbsp;app helps the customer to access the online food ordering platforms, search for the right restaurant or the dish they want to order, place their orders and pay easily.&nbsp;Here is a list of some absolutely necessary and then some additional features of food delivery app your customer app needs. Once the order is prepared, the driver picks the order and travels to the customer's location, using the&nbsp;navigation in the app, to deliver the food. Customers can track the live order status, check the delivery person's location and estimated time of arrival in his app.</p>
					<p></p>
                </div>
            </div>
	...
	<form id="contactSeo" className="web_analysis">
		<div className="row px-3 py-2">
			...
			<input type="hidden" name="lead_url" defaultValue="/grocery" />
