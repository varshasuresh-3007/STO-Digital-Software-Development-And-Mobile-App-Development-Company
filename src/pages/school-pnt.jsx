...
export default function SchoolPnt() {
  useEffect(() => {
    // Dynamic SEO Injection
    document.title = "School Pnt";
    ...
    <div className="container">
        <div className="row" style={{"height":"35vh"}}>
            <div className="col-sm-5 text-center">
                <h1 className="font-weight-bold vertical-alignment">SCHOOL PNT <br />PROCESS</h1>
                
            </div>
            <div className="col-sm-7 main-image text-center">
                <img src="/debug/img/school_pnt.png" alt="product page image" width="80%" height="80%" className="product-drlog" />

            </div>

        </div>
        <div className="hero-text"><br />
            <h2 className="text-center">Works on all Platforms -Web, iOS &amp; Android</h2>
        </div>

        <div className="row related-btns">
   ...
   <div className="container-fluid">
       ...
       <div className="product-description--div p-4">
               ...
               <div className="row technology_contents-ui">
                   <div className="col-sm-12">
                       <h2 className="font-weight-bold text-let pb-2 text-center">About School PNT</h2>
                   </div>
               </div>
               ...
               <div className="row project-mean">
                   <div className="col-sm-12">
                       <p className="text-justify px-5 pb-1 mb-0">
                           STO DIGITAL delivers the complete solution software for the management of all school operations from exams to events. We also offer a common interactive platform to combine parents, students and teachers for the online report of daily class activities. Our solution fits perfectly with your needs and requirements.
                       </p>
                       <p className="text-justify px-5 pb-1 mb-0">
                           Benefits of the school management software include easy access to documents; management  of Admission process, Homework up gradation, Schedule of time-tables, Transportation facility, Fee management, Library management and exam data record.
                       </p>
                   </div>
               </div>
     ...
     <div className="product-description--div technology-list p-4">
        ...
        <div className="row">
            <div className="col-md-6 ">
                <div className="product_list">
                    <ul className="square mb-0">
                        <li><i className="fas fa-phone mr-3"></i>Communication</li>
                        <li><i className="fas fa-th mr-3"></i>Attendance</li>
                        <li><i className="fas fa-book mr-3"></i>Subjects</li>
                        <li><i className="fas fa-bookmark mr-3"></i>Instant access to administrative processes</li>
                        <li><i className="fas fa-sign-out-alt mr-3"></i>Instant access to  academic processes</li>
            ...
            <div className="col-md-6 ">
                <div className="product_list">
                    <ul className="square mb-0">
                        <li><i className="fas fa-envelope mr-3"></i>MailBox </li>
                        <li><i className="fas fa-file mr-3"></i>Tests/Exams</li>
                        <li><i className="fas fa-chart-area mr-3"></i>Student attendance report</li>
                        <li><i className="far fa-money-bill-alt mr-3"></i>Online Fee payment</li>
                        <li><i className="fas fa-bus-alt mr-3"></i>Bus locator</li>
                ...
                <div className="row p-4 technology_contents-ui">
                    <div className="col-sm-6 technology_details">
                        ...
                        <div className="row  px-4">
                            <p className="text-justify">We keep track of every student’s information like attendance, homework, discipline, score etc. which can be accessed easily when needed by the teachers or school managing committee.  In addition to these, the basic database is also available like</p>
                        </div>
                        <div className="row pb-4 ">
                            <div className="col-md-6">
                                <div className="row admin_login">

                                    <ul className="list_color mb-0" style={{"listStyleType":"none"}}>
                                        <li>
                                            <i className="far fa-check-circle list-icon"></i>
                                            Name
                                        </li>
                                        <li>
                                            <i className="far fa-check-circle list-icon"></i>
                    ...
                    <div className="col-sm-6 ">
                        <img src="/debug/img/prod-3.png" className="image-shadow-common img-fluid" alt="Student portal" width="" height="" />
                    </div>
            ...
            <div className="product-description--div p-4">
                <div className="row technology_contents-ui">
                    <div className="col-sm-6 ">
                        <img src="/debug/img/prod-5.png" className="image-shadow-common img-fluid" alt="Parent portal" width="" height="" />
                    </div>
                    <div className="col-sm-6 technology_details">
                        <div className="row  px-4  pb-2">
                            <div className="col-12">
                                <h2 className="font-weight-bold ">Parent Portal</h2>
                            </div>
                        </div>
                        <div className="row  px-4">
                            <p className="text-justify">To help parents evaluate their child’s educational activities, send notice of meetings and annual reports and to bring them in contact with teachers. </p>
                        </div>
                        <div className="row pb-4 ">
                            <div className="col-md-6">
                                <div className="row admin_login">
            ...
            <div className="product-description--div p-4">
                <div className="row technology_contents-ui">
                    <div className="col-sm-6 technology_details">
                        <div className="row  px-4 pb-2">
                            <div className="col-12">
                                <h2 className="font-weight-bold "> Assessments and Assignments</h2>
                            </div>
                        </div>
                        <div className="row  px-4">
                            <p className="text-justify">A different set of examination papers can be prepared by teachers easily for avoiding cheating. </p>
                        </div>
                        <div className="row pb-4 ">
                            <div className="col-md-6">
                                <div className="row admin_login">
                    ...
                    <div className="col-sm-6">
                        <img src="/debug/img/prod-2.png" className="image-shadow-common img-fluid" alt="Parent portal" width="" height="" />
                    </div>
                </div>
            </div>
            ...
            <div className="product-description--div p-4">
               <div className="row technology_contents-ui">
                   <div className="col-sm-6">
                       <img src="/debug/img/prod-6.png" className="image-shadow-common img-fluid" alt="Report portal" width="" height="" />
                   </div>
                   <div className="col-sm-6 technology_details">
                       <div className="row  px-4  pb-2">
                           <div className="col-12">
                               <h2 className="font-weight-bold ">Report cards</h2>
                           </div>
                       </div>
                       <div className="row  px-4">
                           <p className="text-justify">The annual report of the academic year can be easily generated by the authorities using our interactive database. Using our school management system software, report cards can be made easily accessible to the parents and students to help them improve their grades.  </p>
                   </div>
            ...
            <div className="product-description--div p-4">
                <div className="row technology_contents-ui">
                    <div className="col-sm-6">
                        <div className="text-center prod_des_image4">
                            <img src="/debug/img/image9.png" className="image-shadow-common" alt="Product1 description image" width="65%" height="65%" />
                        </div>
                    </div>
                    <div className="col-sm-6 technology_details">
                        <div className="row">
                            <div className="col-12">
                                <h2 className="font-weight-bold text-let pl-1 pb-2">Download School PNT APP</h2>
                            </div>
                        </div>
                        <div className="row">
                            <p className="text-justify"><strong>
                                    STO Digital has developed ERP (Educational Resource Planning) system</strong> for the evolution of educational institutes.This app will be used by the Vehicle driver of schools registered with School PnT. It will provide all the information regarding the drivers, arriving time and departure time of school vehicles.
                            </p>
                        </div>
                    </div>
                </div>
       ...
       <div className="product-description--div p-4">
           <div className="row technology_contents-ui">
               <div className="col-md-6 my-3">
                   <div className="text-center prod_des_image4">
                       <h5 className="font-weight-bold">Getting Details</h5>
                       <img src="/debug/img/getting_details.png" className="image-shadow-common" alt="Getting Details" width="80%" height="80%" />
                   </div>
               </div>
               <div className="col-md-6 my-3">
                   <div className="text-center prod_des_image4">
                       <h5 className="font-weight-bold">Last Update Info</h5>
                       <img src="/debug/img/last_update_info.png" className="image-shadow-common" alt="Last Update Info" width="80%" height="80%" />
                   </div>
               </div>
               <div className="col-md-6 my-3">
                   <div className="text-center prod_des_image4">
                       <h5 className="font-weight-bold">Tracking</h5>
                       <img src="/debug/img/tracking.png" className="image-shadow-common" alt="Tracking" width="80%" height="80%" />
                   </div>
               </div>
               <div className="col-md-6 my-3">
                   <div className="text-center prod_des_image4">
                       <h5 className="font-weight-bold">Tracking Full Screen</h5>
                       <img src="/debug/img/tracking_full_screen.png" className="image-shadow-common" alt="Tracking Full Screen" width="80%" height="80%" />
                   </div>
               </div>
           </div>
       </div>
           ...
           <div className="row">
               ...
               <div className="col-md-4 card-margin offset-2">
                   <div className="card card-prod-shadow h-100">
                       <img className="card-img-top our-prod--images px-5 pt-2 image-shadow-common" src="/debug/img/drlog_new.png" alt="A STO Digital Product" />

                       <div className="card-body fixed-card-height">
                           <p className="card-text">Dr. Log has been designed to keep the records of patients</p>
                       </div>

                       <div className="card-body text-center">
                           <a href="/dr-log" className="btn-color-parent">
               ...
               <div className="col-md-4 card-margin">
                   <div className="card card-prod-shadow h-100">
                       <img className="card-img-top our-prod--images px-5 pt-2 image-shadow-common" src="/debug/img/e-learning.png" alt="A STO Digital Product" />

                       <div className="card-body fixed-card-height">
                           <p className="card-text">E- Learning, LMS (learning management system) and CMS development and mobile learning solutions</p>
                       </div>

                       <div className="card-body text-center">
                           <a href="/elearning" className="btn-color-parent">
                               <input type="button" value="Learn More" className="btn-color py-3 px-5" />
                           </a>
                       </div>
                   </div>
	...
	<form id="contactSeo" className="web_analysis">
		<div className="row px-3 py-2">
			...
			<input type="hidden" name="lead_url" defaultValue="/school-pnt" />
