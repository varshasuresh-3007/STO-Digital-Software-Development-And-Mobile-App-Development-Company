    ...
    <div className="container">
        <div className="row" style={{"height":"35vh"}}>
            <div className="col-sm-5 text-center">
                <h1 className="font-weight-bold vertical-alignment">HUMAN RESOURCE MANAGEMENT SYSTEM <br />PROCESS</h1>
            </div>
...
<section className="technology--info technology__margin-0">
          ...
          <div className="product-description--div p-4">
            ...
            <div className="row technology_contents-ui">
                <div className="col-sm-12">
                    <h2 className="font-weight-bold text-let pb-2 text-center">About HRMS</h2>
                </div>
            </div>
        ...
        <div className="product-description--div technology-list p-4">
            ...
            <div className="row">
                <div className="col-md-6 ">
                    <div className="product_list">
                        <ul className="square mb-0">
                            <li><i className="fa fa-users mr-3"></i>Employee management</li>
                            <li><i className="fas fa-clipboard-list mr-3"></i>Attendance</li>
                            <li><i className="fas fa-bullseye mr-3"></i>Training</li>
                            <li><i className="fas fa-stopwatch mr-3"></i>Task scheduling</li>
                        </ul>
                    </div>
                </div>
                ...
                <div className="col-md-6 ">
                    <div className="product_list">
                        <ul className="square mb-0">
                            <li><i className="far fa-calendar-times mr-3"></i>Leave management</li>
                            <li><i className="fas fa-money-bill mr-3"></i>Payroll</li>
                            <li><i className="fas fa-project-diagram mr-3"></i>Project </li>
                            <li><i className="far fa-file mr-3"></i>Report</li>
                        </ul>
                    </div>
                </div>
        ...
        <div className="product-description--div p-4">
            ...
            <div className="row project-mean">
                <div className="col-sm-12">
                    <p className="text-justify px-5 pb-3">
                        Finding a HRMS that fits your needs can be fast and easy! We take the pain out of your search by doing all of the heavy lifting for you and providing you with a short list of highly compatible solutions
                    </p>
                </div>
            </div>
            ...
            <div className="row">
                <div className="col-sm-12 product-enquiry text-center">
                    <a href="#" className="btn-color-parent" target="_blank">
            ...
            <div className="row">
                ...
                <div className="col-md-4 card-margin offset-2">
                    <div className="card card-prod-shadow h-100">
                        <img className="card-img-top our-prod--images px-5 pt-2 image-shadow-common" src="/debug/img/doctor_click.png" alt="A STO Digital Product" />

                        <div className="card-body fixed-card-height">
                            <p className="card-text">Doctor click away  has been designed to connect with doctors</p>
                        </div>

                        <div className="card-body text-center">
                            <a href="/doctor-click-away" className="btn-color-parent">
                ...
                <div className="col-md-4 card-margin">
                    <div className="card card-prod-shadow h-100">
                        <img className="card-img-top our-prod--images px-5 pt-2 image-shadow-common" src="/debug/img/school_pnt.png" alt="A STO Digital Product" />

                        <div className="card-body fixed-card-height">
                            <p className="card-text">Get School ERP system and connect parents with school</p>
                        </div>

                        <div className="card-body text-center">
                            
                            <a href="/school-pnt" className="btn-color-parent">
                                <input type="button" value="Learn More" className="btn-color py-3 px-5 " />
                            </a>
                        </div>
                    </div>
	...
	<form id="contactSeo" className="web_analysis">
		<div className="row px-3 py-2">
			...
			<input type="hidden" name="lead_url" defaultValue="/hrms" />
